...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    private final Paint mPaintStrokeTry = new Paint(ANTI_ALIAS_FLAG);
        ...
        for (int iLoop = 0; iLoop < count; iLoop++) {
        	...
        	if(count >0 && iLoop <count-1){
	            ...
	            if (pageFillRadius != mRadius) {
	            	mPaintStrokeTry.setColor(context.getResources().getColor(R.color.circleBlue));
	                canvas.drawCircle(dX, dY, mRadius, mPaintStrokeTry);
	            }
        }else{
        	// mPaintStrokeTry.setColor(context.getResources().getColor(R.color.circleBlue));
        	// canvas.drawCircle(dX, dY, mRadius, mPaintStrokeTry);
