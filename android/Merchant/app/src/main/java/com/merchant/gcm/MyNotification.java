...
public class MyNotification implements Serializable {
	...
	public enum NotificationType {
		Unknown, TxnInfo, TxnApprovalRequired, TxnDenied, MerchantReviewRequested
	}
	...
	public MyNotification(Bundle bundle) {
		...
		if (notifType != NotificationType.Unknown && transactionId != null) {
			canBeHandled = true;
		}
	}
	...
	public void buildNotification(Context context) {
		...
		int notifIcon = R.drawable.logo_sbi_mid;
		...
		Intent noActionIntent = this.getIntentForNone(context);
		PendingIntent noActionPendingIntent = PendingIntent.getActivity(
				context, 0, noActionIntent, PendingIntent.FLAG_CANCEL_CURRENT);

		mBuilder.setContentIntent(noActionPendingIntent);
	...
	private void showInformativeDialog(final Context context) {
