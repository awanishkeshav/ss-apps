...
public class DateUtil {
	...
	public static HashMap<String, ArrayList<Transaction>> groupDates(ArrayList<Transaction> transactions){
		
		
		
		HashMap<String, ArrayList<Transaction>> map = new HashMap<String, ArrayList<Transaction>>();
		ArrayList<Transaction> toadyList = new ArrayList<Transaction>();
		map.put(KEY_TODAY, toadyList);
		ArrayList<Transaction> yesterDayList = new ArrayList<Transaction>();
		map.put(KEY_YESTERDAY, yesterDayList);
		ArrayList<Transaction> twoDaysAgoList = new ArrayList<Transaction>();
		map.put(KEY_TWO_DAYS_AGO, twoDaysAgoList);
		ArrayList<Transaction> lastWeekList = new ArrayList<Transaction>();
		map.put(KEY_LAST_WEEK, lastWeekList);
		ArrayList<Transaction> lastMontList = new ArrayList<Transaction>();
		map.put(KEY_LAST_MONTH, lastMontList);
		ArrayList<Transaction> olderList = new ArrayList<Transaction>();
		map.put(KEY_OLDER, olderList);
		
		for (int i = 0; i < transactions.size(); i++) {
			Transaction tranx = transactions.get(i);
