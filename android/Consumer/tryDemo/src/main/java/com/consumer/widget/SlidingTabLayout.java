...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabStrip = new SlidingTabStrip(context, context.getResources().getColor(R.color.TabPager));
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            for(int i = 0; i < tabStripChildCount; i ++){
            	((TextView)mTabStrip.getChildAt(i)).setTextColor(getResources().getColor(R.color.TabPager));
            }
